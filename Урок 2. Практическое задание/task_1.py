...
def calc():
    ...
    # Проверяем, является ли операция допустимой
    if operation not in ('+', '-', '*', '/'):
        print("Неверный знак операции! Попробуйте еще раз.")
        return calc()  # Повторно вызываем функцию для ввода корректной операции
    ...
    if operation == '+':
        ...
        if num2 == 0:
            ...
            return calc()  # Повторно вызываем функцию для новой операции
        result = num1 / num2

    # Выводим результат
    print(f"Ваш результат: {result}")

    # Рекурсивный вызов для следующего вычисления
    return calc()
